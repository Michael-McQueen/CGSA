...
class BaseConfig(object):
    ...
    def __init__(self) -> None:
        ...
        # self.dinosaur :nn.Module = None 
        # self.vis_encoder :nn.Module = None 
        self.use_teacher :bool = False
        self.use_HSA :bool = False
        self.burn_epochs :int = 36
        self.pseudo_threshold :float = 0.5
        self.ema_decay_teacher :float = 0.9997
        self.nms_iou_threshold :float = 0.5
        self.t_max :float = 0.5
        self.t_min :float = 0.1
        self.beta :float = 0.2
        self.thresholdmethod :str = 'exp'
        self.teacher_path :Path = None
