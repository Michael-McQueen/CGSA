...
def convert_to_coco_api(ds):
    ...
    if hasattr(ds, 'label_id2name'):
        dataset["categories"] = [{"id": i, "name": ds.label_id2name.get(i, str(i))} for i in sorted_cat_ids]
    elif hasattr(ds, 'label_names'):
        dataset["categories"] = [{"id": i, "name": ds.label_names[i] if i < len(ds.label_names) else str(i)} for i in sorted_cat_ids]
    else:
        dataset["categories"] = [{"id": i} for i in sorted_cat_ids]
